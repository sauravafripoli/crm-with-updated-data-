...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php get_theme_url(); ?>/CSS/style.css?v=<?php echo get_site_version(); ?>" />
    <link href="https://afripoli.org/assets/themes/magazine/css/plugins-2.4.min.css" rel="stylesheet">
    <link href="<?php get_theme_url(); ?>/assets/css/style.min.css?v=<?php echo get_site_version(); ?>" rel="stylesheet">
