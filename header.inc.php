...
<html lang="en">
	<head>
		...
		<meta property="og:type" content="map"> <!-- Can also be 'article', 'video', etc. -->
		<!-- Twitter Card metadata for sharing on Twitter -->
		<meta name="twitter:card" content="summary_large_image"> <!-- Card type, e.g., 'summary', 'summary_large_image' -->
		...
		<link href="https://afripoli.org/assets/css/plugins-2.3.min.css" rel="stylesheet">
		<link rel="stylesheet" type="text/css" href="<?php get_theme_url(); ?>/assets/css/style-2.3.min.css?v=<?php echo get_site_version(); ?>">
	</head>
	<?php get_header(); ?>
	<body>
														...
														<ul>
															...
															<li class="has-children has-children--multilevel-submenu">
																...
																<ul class="submenu">
																	...
																	<li><a href="https://afripoli.org/projects/crm-mapping"><span>Green Mineral Mapping</span></a></li>
																</ul>
															</li>
															<li>
