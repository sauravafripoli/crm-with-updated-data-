	...
	tooltip.html(`
		<div style="display: flex; flex-direction: column; width: 135px; position: relative;">
		  ...
		  <div style="display: flex; justify-content: space-between; width: 135px;">
			<h3 style="margin: 0; font-family: 'Roboto',   sans-serif; font-weight: bold; font-size: 13pt">${countryName}</h3>
			
		  </div>
		  <p style="margin: 5px 0; margin-top: 8px; font-family: 'Roboto', sans-serif; font-size: 11pt">${partnerCount} partner${
	  partnerCount !== 1 ? "s" : ""
	}</p>
		  <ul style="padding: 0; margin: 0; margin-top: 8px; font-size: 11pt; font-family: 'Roboto', sans-serif;">
			${partnersList
	...
	if (!isMobile) {
	  ...
	  if (areaInSquareKm.toFixed(2) < 250000) {
		...
		g.append("image")
		  ...
		  .attr("xlink:href", "https://afripoli.org/projects/crm-mapping/theme/apri-crm/img/icons/noun.svg")
		  .attr("width", 20)
		  .attr("height", 20)
		  .attr(
			"x",
